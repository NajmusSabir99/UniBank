...
public class ViewFactory {
    ...
    private void createStage(FXMLLoader loader) {
        ...
        try {
            ...
            // Create a ScrollPane and set the root layout as its content
            ScrollPane scrollPane = new ScrollPane(root);

            // Ensure the ScrollPane fits the window width and height
            scrollPane.setFitToWidth(true);  // Ensures the scroll pane fits the full width of the window
            scrollPane.setFitToHeight(false); // Allow vertical scrolling, but content will determine height

            // Create the scene with the ScrollPane as the root
        ...
        stage.setScene(scene);
        stage.getIcons().add(new Image(String.valueOf(getClass().getResource("/Images/appIcon.png"))));
        stage.setResizable(true);  // Allow the window to resize based on the content
        stage.setTitle("UNIBANK");
